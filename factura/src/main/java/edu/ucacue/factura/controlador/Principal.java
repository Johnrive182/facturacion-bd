		...
		do {
			...
			case 2:
				try {
					...
					Persona personamodificada = personaRepository.findByCedula(c1);
			...
			case 3:
				try {
					...
					List<Persona> personanom = personaRepository.findByNombre(nomb);
					...
					Persona personaid = personaRepository.findById(id);
			...
			case 4:
				...
				List<Persona> personas = personaRepository.findByNombre(nom);
